<template>
  <div class="flex justify-center gap-2">
    <!-- Nút điều hướng về trang đầu -->
    <button @click="goToPage(0)" :disabled="currentPage === 0"
            class="px-4 py-2 border rounded bg-gray-300 hover:bg-orange-500 text-black hover:text-white shadow-md disabled:opacity-50">
