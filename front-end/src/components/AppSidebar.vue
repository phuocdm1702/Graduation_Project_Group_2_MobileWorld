        ...
        <div>
          <div class="relative">
            <button
              ...
              class="flex items-center w-full px-6 py-2 mt-4 duration-200 border-l-4"
              :class="[isOpen1 ? activeClass : inactiveClass]"
            >
              ...
              <span class="mx-4">Quản lý đơn hàng</span>
              <svg
            ...
            <div v-if="isOpen1" class="ml-8">
              <router-link
                class="flex items-center gap-x-3 block px-6 py-2 mt-2 duration-200 border-l-4"
                :class="[
                  $route.name === 'HoaDon' ? activeClass : inactiveClass,
                ]"
                to="/hoa-don"
              >
                <svg
              ...
              <router-link
                class="flex items-center gap-x-3 block px-6 py-2 mt-2 duration-200 border-l-4"
                :class="[
                  $route.name === 'LichSuHD' ? activeClass : inactiveClass,
                ]"
                to="/lich-su-hoa-don"
              >
                <svg
                ...
                <span class="mx-4">Lịch sử hóa đơn</span>
              </router-link>
              <router-link
                class="flex items-center gap-x-3 block px-6 py-2 mt-2 duration-200 border-l-4"
                :class="[$route.name === 'HDCT' ? activeClass : inactiveClass]"
                to="/hoa-don-chi-tiet"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="mx-4">Hóa đơn chi tiết</span>
              </router-link>
            </div>
          </div>
        </div>
        ...
        <div>
          <div class="relative">
            <button
              ...
              class="flex items-center w-full px-6 py-2 mt-4 duration-200 border-l-4"
              :class="[isOpen5 ? activeClass : inactiveClass]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
        ...
        <div>
          <div class="relative">
            <button
              ...
              class="flex items-center w-full px-6 py-2 mt-4 duration-200 border-l-4"
              :class="[isOpen2 ? activeClass : inactiveClass]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
          ...
          <div class="relative">
            ...
            <div v-if="isOpen3" class="ml-8">
              <router-link
                class="flex items-center gap-x-3 block px-6 py-2 mt-2 duration-200 border-l-4"
                :class="[
                  $route.name === 'NhanVien' ? activeClass : inactiveClass,
                ]"
                to="/nhan-vien"
              >
                <svg
              ...
              <router-link
                class="flex items-center gap-x-3 block px-6 py-2 mt-2 duration-200 border-l-4"
                :class="[
                  $route.name === 'KhachHang' ? activeClass : inactiveClass,
                ]"
                to="/khach-hang"
              >
                <svg
          ...
          <div class="relative">
            ...
            <div v-if="isOpen4" class="ml-8">
              <router-link
                class="flex items-center gap-x-3 block px-6 py-2 mt-2 duration-200 border-l-4"
                :class="[
                  $route.name === 'PhieuGiamGia' ? activeClass : inactiveClass,
                ]"
                to="/phieu-giam-gia"
              >
                <svg
              ...
              <router-link
                class="flex items-center gap-x-3 block px-6 py-2 mt-2 duration-200 border-l-4"
                :class="[
                  $route.name === 'DotGiamGia' ? activeClass : inactiveClass,
                ]"
                to="/dot-giam-gia"
              >
                <svg
...
const { isOpen1 } = useSidebar();
const { isOpen2 } = useSidebar();
const { isOpen3 } = useSidebar();
...
function toggleDropdown5() { // Thêm toggleDropdown5
