  ...
  <div class="mt-8 max-w-screen-xl mx-auto">
    ...
    <div class="overflow-x-auto mt-6 bg-white shadow-lg rounded-lg p-4">
      <table class="w-full min-w-max table-auto border-collapse">
        ...
        <tbody>
        <tr v-for="hoaDon in dataTable" :key="hoaDon.id" class="text-gray-700 border-b hover:bg-gray-50">
          <td class="td-cell">{{ hoaDon.idKhachHang.id }}</td>
          <td class="td-cell">{{ hoaDon.idNhanVien.id }}</td>
          ...
          <td class="td-cell">{{ hoaDon.tenKhachHang }}</td>
