<template>
  <div>
        ...
        <div class="w-full max-w-4xl overflow-hidden bg-white border rounded-md shadow-md">
          <form>
            <div class="flex items-center justify-between px-5 py-3 text-gray-700 border-b">
              <h3 class="text-sm">Thêm Công nghệ sạc</h3>
              <button>
            ...
            <div class="p-5 text-gray-700 bg-gray-200 border-b grid grid-cols-3 gap-4">
              ...
              <div>
                <label class="text-xs">Tên công nghệ</label>
                <input type="text" class="w-full px-4 py-2 mt-2 border rounded-md" />
              </div>
            </div>
    ...
    <div class="mt-8">
      <h4 class="text-gray-600">Danh sách Công nghệ sạc</h4>
      <div class="mt-4">
        <table class="w-full bg-white rounded-md shadow-md">
          ...
          <tr class="bg-gray-200 text-gray-700">
            ...
            <th class="px-4 py-2">Tên công nghệ</th>
          ...
          <tr class="border-t text-center" v-for="chargingTech in chargingTechnologies" :key="chargingTech.id">
            ...
            <td class="px-4 py-2">{{ chargingTech.name }}</td>
            <td class="px-4 py-2">
...
const breadcrumbItems = computed(() => {
  ...
  return route.meta?.breadcrumb || ["Công nghệ sạc"]; // Mặc định nếu không có breadcrumb
});

const chargingTechnologies = ref([
  { id: "CH001", code: "CHG001", name: "Sạc nhanh 30W" },
  { id: "CH002", code: "CHG002", name: "Sạc không dây 15W" }
]);
</script>