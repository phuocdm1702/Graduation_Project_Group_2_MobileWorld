<template>
  <div>
    <!-- Breadcrumb -->
    <Breadcrumb breadcrumb="Imel" />

    <div class="mt-4">
      <h4 class="text-gray-600">Quản Lý Imel</h4>
        ...
        <div class="w-full max-w-4xl overflow-hidden bg-white border rounded-md shadow-md">
          <form>
            ...
            <div class="p-5 text-gray-700 bg-gray-200 border-b grid grid-cols-3 gap-4">
              ...
              <div>
                <label class="text-xs">Imel</label>
                <input type="text" class="w-full px-4 py-2 mt-2 border rounded-md" />
              </div>
            </div>
    ...
    <div class="mt-8">
      <h4 class="text-gray-600">Danh sách Imel</h4>
      <div class="mt-4">
        <table class="w-full bg-white rounded-md shadow-md">
          <thead>
            <tr class="bg-gray-200 text-gray-700">
              ...
              <th class="px-4 py-2">Imel</th>
              <th class="px-4 py-2">Hành động</th>
            </tr>
          </thead>
          <tbody>
            <tr class="border-t text-center" v-for="imel in imelList" :key="imel.id">
              <td class="px-4 py-2">{{ imel.id }}</td>
              <td class="px-4 py-2">{{ imel.code }}</td>
              <td class="px-4 py-2">{{ imel.imel }}</td>
              <td class="px-4 py-2">
...
const imelList = ref([
  { id: "IM001", code: "A123", imel: "356789012345678" },
  { id: "IM002", code: "B456", imel: "356789012345679" },
  { id: "IM003", code: "C789", imel: "356789012345680" }
]);
</script>
