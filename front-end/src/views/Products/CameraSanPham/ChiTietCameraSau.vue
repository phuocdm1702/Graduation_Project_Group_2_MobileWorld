<template>
  <div>
    <!-- Breadcrumb -->
    <Breadcrumb breadcrumb="Chi tiết Camera Sau" />

    <div class="mt-4">
      <h4 class="text-gray-600">Chi tiết Camera Sau</h4>
        ...
        <div class="w-full max-w-4xl overflow-hidden bg-white border rounded-md shadow-md">
          <form>
            <div class="flex items-center justify-between px-5 py-3 text-gray-700 border-b">
              <h3 class="text-sm">Thêm Chi tiết Camera Sau</h3>
              <button>
            ...
            <div class="p-5 text-gray-700 bg-gray-200 border-b grid grid-cols-3 gap-4">
              ...
              <div>
                <label class="text-xs">ID Camera Sau</label>
                <select class="w-full px-4 py-2 mt-2 border rounded-md">
    ...
    <div class="mt-8">
      <h4 class="text-gray-600">Danh sách Chi tiết Camera Sau</h4>
      <div class="mt-4">
        <table class="w-full bg-white rounded-md shadow-md">
          <thead>
            <tr class="bg-gray-200 text-gray-700">
              ...
              <th class="px-4 py-2">ID Camera Sau</th>
          ...
          <tbody>
            <tr class="border-t text-center" v-for="detail in cameraDetails" :key="detail.id">
              ...
              <td class="px-4 py-2">{{ detail.rearCameraId }}</td>
...
const cameraDetails = ref([
  { id: "CS001", clusterId: "CC001", rearCameraId: "RC001", code: "CAM4001" },
  { id: "CS002", clusterId: "CC002", rearCameraId: "RC002", code: "CAM4002" }
]);
</script>
