<template>
  <div>
    <!-- Breadcrumb -->
    <Breadcrumb breadcrumb="Quản lý Camera" />

    <div class="mt-4">
      <h4 class="text-gray-600">Quản lý Camera</h4>
        ...
        <div class="w-full max-w-4xl overflow-hidden bg-white border rounded-md shadow-md">
          <form>
            <div class="flex items-center justify-between px-5 py-3 text-gray-700 border-b">
              <h3 class="text-sm">Thêm Camera</h3>
              <button>
            ...
            <div class="p-5 text-gray-700 bg-gray-200 border-b grid grid-cols-3 gap-4">
              ...
              <div>
                <label class="text-xs">Tên Camera</label>
                <input type="text" class="w-full px-4 py-2 mt-2 border rounded-md" />
              </div>
            </div>
    ...
    <div class="mt-8">
      <h4 class="text-gray-600">Danh sách Camera</h4>
      <div class="mt-4">
        <table class="w-full bg-white rounded-md shadow-md">
          <thead>
            <tr class="bg-gray-200 text-gray-700">
              ...
              <th class="px-4 py-2">Tên Camera</th>
...
const cameras = ref([
  { id: "CM001", code: "CAM1001", name: "Camera 360" },
  { id: "CM002", code: "CAM1002", name: "Camera Hồng Ngoại" }
]);
</script>
