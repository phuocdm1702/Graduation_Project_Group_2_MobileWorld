<template>
  <div>
    <!-- Breadcrumb -->
    <Breadcrumb breadcrumb="Quản lý Nhà Sản Xuất" />

    <div class="mt-4">
      <h4 class="text-gray-600">Quản lý Nhà Sản Xuất</h4>
      <div class="mt-4">
        <div class="w-full max-w-4xl overflow-hidden bg-white border rounded-md shadow-md">
          <form>
            <div class="flex items-center justify-between px-5 py-3 text-gray-700 border-b">
              <h3 class="text-sm">Thêm Nhà Sản Xuất</h3>
              <button>
            ...
            <div class="p-5 text-gray-700 bg-gray-200 border-b grid grid-cols-2 gap-4">
              ...
              <div>
                <label class="text-xs">Tên Nhà Sản Xuất</label>
                <input type="text" class="w-full px-4 py-2 mt-2 border rounded-md" />
              </div>
            </div>
    ...
    <div class="mt-8">
      <h4 class="text-gray-600">Danh sách Nhà Sản Xuất</h4>
      <div class="mt-4">
        <table class="w-full bg-white rounded-md shadow-md">
          <thead>
            <tr class="bg-gray-200 text-gray-700">
              ...
              <th class="px-4 py-2">Tên Nhà Sản Xuất</th>
              <th class="px-4 py-2">Hành động</th>
            </tr>
          </thead>
          <tbody>
            <tr class="border-t text-center" v-for="manufacturer in manufacturers" :key="manufacturer.id">
              <td class="px-4 py-2">{{ manufacturer.id }}</td>
              <td class="px-4 py-2">{{ manufacturer.code }}</td>
...
const manufacturers = ref([
  { id: "NSX001", code: "NSX001", name: "Nhà sản xuất A" },
  { id: "NSX002", code: "NSX002", name: "Nhà sản xuất B" }
]);
</script>
