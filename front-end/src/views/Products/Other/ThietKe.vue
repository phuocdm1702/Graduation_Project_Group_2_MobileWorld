<template>
  <div>
    <!-- Breadcrumb -->
    <Breadcrumb breadcrumb="Thiết kế" />

    <div class="mt-4">
      <h4 class="text-gray-600">Thiết kế</h4>
        ...
        <div class="w-full max-w-4xl overflow-hidden bg-white border rounded-md shadow-md">
          <form>
            <div class="flex items-center justify-between px-5 py-3 text-gray-700 border-b">
              <h3 class="text-sm">Thêm Thiết kế</h3>
              <button>
            ...
            <div class="p-5 text-gray-700 bg-gray-200 border-b grid grid-cols-3 gap-4">
              ...
              <div>
                <label class="text-xs">Chất liệu khung</label>
                <input type="text" class="w-full px-4 py-2 mt-2 border rounded-md" />
              </div>
              <div>
                <label class="text-xs">Chất liệu mặt lưng</label>
                <input type="text" class="w-full px-4 py-2 mt-2 border rounded-md" />
              </div>
            </div>
    ...
    <div class="mt-8">
      <h4 class="text-gray-600">Danh sách Thiết kế</h4>
      <div class="mt-4">
        <table class="w-full bg-white rounded-md shadow-md">
          <thead>
            <tr class="bg-gray-200 text-gray-700">
              ...
              <th class="px-4 py-2">Chất liệu khung</th>
              <th class="px-4 py-2">Chất liệu mặt lưng</th>
              <th class="px-4 py-2">Hành động</th>
            </tr>
          </thead>
          <tbody>
            <tr class="border-t text-center" v-for="design in designs" :key="design.id">
              <td class="px-4 py-2">{{ design.id }}</td>
              <td class="px-4 py-2">{{ design.code }}</td>
              <td class="px-4 py-2">{{ design.frameMaterial }}</td>
              <td class="px-4 py-2">{{ design.backMaterial }}</td>
              <td class="px-4 py-2">
...
const designs = ref([
  { id: "D001", code: "DES001", frameMaterial: "Nhôm", backMaterial: "Kính" },
  { id: "D002", code: "DES002", frameMaterial: "Nhựa", backMaterial: "Nhựa" }
]);
</script>
