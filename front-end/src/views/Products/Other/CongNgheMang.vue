<template>
  <div>
    <!-- Breadcrumb -->
    <Breadcrumb breadcrumb="Công Nghệ Mạng" />

    <div class="mt-4">
      <h4 class="text-gray-600">Công Nghệ Mạng</h4>
        ...
        <div class="w-full max-w-4xl overflow-hidden bg-white border rounded-md shadow-md">
          <form>
            <div class="flex items-center justify-between px-5 py-3 text-gray-700 border-b">
              <h3 class="text-sm">Thêm Công Nghệ Mạng</h3>
              <button>
            ...
            <div class="p-5 text-gray-700 bg-gray-200 border-b grid grid-cols-3 gap-4">
              ...
              <div>
                <label class="text-xs">Tên công nghệ mạng</label>
                <input type="text" class="w-full px-4 py-2 mt-2 border rounded-md" />
              </div>
            </div>
    ...
    <div class="mt-8">
      <h4 class="text-gray-600">Danh sách Công Nghệ Mạng</h4>
      <div class="mt-4">
        <table class="w-full bg-white rounded-md shadow-md">
          <thead>
            <tr class="bg-gray-200 text-gray-700">
              ...
              <th class="px-4 py-2">Tên công nghệ mạng</th>
              <th class="px-4 py-2">Hành động</th>
            </tr>
          </thead>
          <tbody>
            <tr class="border-t text-center" v-for="network in networkTechnologies" :key="network.id">
              <td class="px-4 py-2">{{ network.id }}</td>
              <td class="px-4 py-2">{{ network.code }}</td>
...
const networkTechnologies = ref([
  { id: "NT001", code: "5G", name: "Mạng 5G" },
  { id: "NT002", code: "4G", name: "Mạng 4G" },
  { id: "NT003", code: "3G", name: "Mạng 3G" }
]);
</script>
