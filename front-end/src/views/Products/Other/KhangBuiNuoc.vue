<template>
  <div>
    <!-- Breadcrumb -->
    <Breadcrumb breadcrumb="Kháng bụi và Kháng nước" />

    <div class="mt-4">
      <h4 class="text-gray-600">Kháng bụi và Kháng nước</h4>
        ...
        <div class="w-full max-w-4xl overflow-hidden bg-white border rounded-md shadow-md">
          <form>
            <div class="flex items-center justify-between px-5 py-3 text-gray-700 border-b">
              <h3 class="text-sm">Thêm Kháng bụi và Kháng nước</h3>
              <button>
            ...
            <div class="p-5 text-gray-700 bg-gray-200 border-b grid grid-cols-3 gap-4">
              ...
              <div>
                <label class="text-xs">Tên chỉ số</label>
                <input type="text" class="w-full px-4 py-2 mt-2 border rounded-md" />
              </div>
            </div>
    ...
    <div class="mt-8">
      <h4 class="text-gray-600">Danh sách Kháng bụi và Kháng nước</h4>
      <div class="mt-4">
        <table class="w-full bg-white rounded-md shadow-md">
          <thead>
            <tr class="bg-gray-200 text-gray-700">
              ...
              <th class="px-4 py-2">Tên chỉ số</th>
              <th class="px-4 py-2">Hành động</th>
            </tr>
          </thead>
          <tbody>
            <tr class="border-t text-center" v-for="resistance in resistances" :key="resistance.id">
              <td class="px-4 py-2">{{ resistance.id }}</td>
              <td class="px-4 py-2">{{ resistance.code }}</td>
              <td class="px-4 py-2">{{ resistance.indexName }}</td>
              <td class="px-4 py-2">
...
const resistances = ref([
  { id: "R001", code: "IP67", indexName: "Kháng bụi và nước tiêu chuẩn IP67" },
  { id: "R002", code: "IP68", indexName: "Kháng bụi và nước tiêu chuẩn IP68" }
]);
</script>
