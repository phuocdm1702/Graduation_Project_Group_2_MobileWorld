<template>
  <div>
    <!-- Breadcrumb -->
    <Breadcrumb breadcrumb="Tình trạng" />

    <div class="mt-4">
      <h4 class="text-gray-600">Tình trạng</h4>
        ...
        <div class="w-full max-w-4xl overflow-hidden bg-white border rounded-md shadow-md">
          <form>
            <div class="flex items-center justify-between px-5 py-3 text-gray-700 border-b">
              <h3 class="text-sm">Thêm Tình trạng</h3>
              <button>
            ...
            <div class="p-5 text-gray-700 bg-gray-200 border-b grid grid-cols-3 gap-4">
              ...
              <div>
                <label class="text-xs">Loại tình trạng</label>
                <input type="text" class="w-full px-4 py-2 mt-2 border rounded-md" />
              </div>
            </div>
    ...
    <div class="mt-8">
      <h4 class="text-gray-600">Danh sách Tình trạng</h4>
      <div class="mt-4">
        <table class="w-full bg-white rounded-md shadow-md">
          <thead>
            <tr class="bg-gray-200 text-gray-700">
              ...
              <th class="px-4 py-2">Loại tình trạng</th>
              <th class="px-4 py-2">Hành động</th>
            </tr>
          </thead>
          <tbody>
            <tr class="border-t text-center" v-for="condition in conditions" :key="condition.id">
              <td class="px-4 py-2">{{ condition.id }}</td>
              <td class="px-4 py-2">{{ condition.code }}</td>
              <td class="px-4 py-2">{{ condition.type }}</td>
              <td class="px-4 py-2">
...
const conditions = ref([
  { id: "T001", code: "CON001", type: "Mới" },
  { id: "T002", code: "CON002", type: "Like New" }
]);
</script>
