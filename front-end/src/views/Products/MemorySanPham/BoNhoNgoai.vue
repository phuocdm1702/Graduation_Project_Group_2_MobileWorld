<template>
  <div>
    <!-- Breadcrumb -->
    <Breadcrumb breadcrumb="Hỗ trợ bộ nhớ ngoài" />

    <div class="mt-4">
      <h4 class="text-gray-600">Hỗ trợ bộ nhớ ngoài</h4>
        ...
        <div class="w-full max-w-4xl overflow-hidden bg-white border rounded-md shadow-md">
          <form>
            <div class="flex items-center justify-between px-5 py-3 text-gray-700 border-b">
              <h3 class="text-sm">Thêm Hỗ trợ bộ nhớ ngoài</h3>
              <button>
            ...
            <div class="p-5 text-gray-700 bg-gray-200 border-b grid grid-cols-3 gap-4">
              ...
              <div>
                <label class="text-xs">Hỗ trợ bộ nhớ ngoài</label>
                <input type="text" class="w-full px-4 py-2 mt-2 border rounded-md" />
              </div>
            </div>
    ...
    <div class="mt-8">
      <h4 class="text-gray-600">Danh sách Hỗ trợ bộ nhớ ngoài</h4>
      <div class="mt-4">
        <table class="w-full bg-white rounded-md shadow-md">
          <thead>
            <tr class="bg-gray-200 text-gray-700">
              ...
              <th class="px-4 py-2">Hỗ trợ bộ nhớ ngoài</th>
              <th class="px-4 py-2">Hành động</th>
            </tr>
          </thead>
          <tbody>
            <tr class="border-t text-center" v-for="externalStorage in externalStorages" :key="externalStorage.id">
              <td class="px-4 py-2">{{ externalStorage.id }}</td>
              <td class="px-4 py-2">{{ externalStorage.code }}</td>
              <td class="px-4 py-2">{{ externalStorage.support }}</td>
              <td class="px-4 py-2">
...
const externalStorages = ref([
  { id: "EXT001", code: "EXT001", support: "Có" },
  { id: "EXT002", code: "EXT002", support: "Không" },
  { id: "EXT003", code: "EXT003", support: "Có" }
]);
</script>
