<template>
  <div>
    ...
    <div className="mt-2 mx-auto">
      <div
        className="bg-white shadow-lg rounded-lg p-5 mb-2 mt-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        <div>
          <label htmlFor="searchQuery" className="block text-sm font-medium text-gray-700 mb-1">Tìm kiếm phiếu</label>
        ...
        <div>
          ...
          <input v-model="minOrder" id="minOrder" type="number" placeholder="Hóa đơn tối thiểu"
                 className="input-field"/>
        </div>
        <div>
          <label htmlFor="valueFilter" className="block text-sm font-medium text-gray-700 mb-1">Giá trị phiếu</label>
          <input v-model="valueFilter" id="valueFilter" type="number" placeholder="Giá trị phiếu"
                 className="input-field"/>
        </div>
