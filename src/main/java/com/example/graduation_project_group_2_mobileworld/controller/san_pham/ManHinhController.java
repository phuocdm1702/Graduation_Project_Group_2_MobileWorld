...
import com.example.graduation_project_group_2_mobileworld.service.san_pham.ManHinhService;
...
public class ManHinhController {
    ...
    public ResponseEntity<Page<ManHinhDTO>> search(
        ...
        Page<ManHinhDTO> result = service.searchManHinh(
                keyword, kieuManHinh, idCongNgheManHinh, kichThuoc, doPhanGiai, doSangToiDa, tanSoQuet, pageable
        );
